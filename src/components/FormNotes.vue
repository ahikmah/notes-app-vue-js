<template>
  <div class="formNotes">
    ...
    <div class="content">
      ...
      <textarea class="text textarea" placeholder="Go ahead, put anything" v-model="description"></textarea> 
    </div>
    </form>
  </div>
</template>
...
export default {
  ...
  data: function () {
    return {
      title: this.propContent?.title|| '',
      description: this.propContent?.description|| ''
    }
  },
  methods: {
    submitNote(e){
